...
def loglog_ice_time_per_step_by_om2_ncpus(df,
        marker='+'):
    p = ppd.loglog("om2_ncpus", "ice_time_per_step", 
        data=df, 
        xlabel="OM2 number of CPUs",
...
def semilogx_ice_cpu_time_per_step_by_om2_ncpus(df,
        marker='+'):
    p = ppd.semilogx("om2_ncpus", "ice_cpu_time_per_step", 
        data=df, 
        xlabel="OM2 number of CPUs",
...
def loglog_ocean_time_per_step_by_om2_ncpus(df,
        marker='+'):
    p = ppd.loglog("om2_ncpus", "ocean_time_per_step", 
        data=df, 
        xlabel="OM2 number of CPUs",
...
def semilogx_ocean_cpu_time_per_step_by_om2_ncpus(df,
        marker='+'):                                                  
    p = ppd.semilogx("om2_ncpus", "ocean_cpu_time_per_step", 
        data=df, 
        xlabel="OM2 number of CPUs",
...
def loglog_ice_time_per_step_by_ncpus(df,
        marker='+'):                                      
    p = ppd.loglog("ice_ncpus", "ice_time_per_step", 
        data=df, 
        xlabel="CICE number of CPUs",
        ylabel="CICE time per step (s)",
        marker=marker)
...
def semilogx_ice_cpu_time_per_step_by_ncpus(df,
        marker='+'):                                            
    p = ppd.semilogx("ice_ncpus", "ice_cpu_time_per_step", 
        data=df, 
        xlabel="CICE number of CPUs",
...
def loglog_ocean_time_per_step_by_ncpus(df,
        marker='+'):                                        
    p = ppd.loglog("ocean_ncpus", "ocean_time_per_step", 
        data=df, 
        xlabel="MOM number of CPUs",
        ylabel="MOM time per step (s)",
        marker=marker)
...
def semilogx_ocean_cpu_time_per_step_by_ncpus(df,
        marker='+'):                                              
    p = ppd.semilogx("ocean_ncpus", "ocean_cpu_time_per_step", 
        data=df, 
        xlabel="MOM number of CPUs",
